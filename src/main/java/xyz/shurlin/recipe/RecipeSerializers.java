...
public class RecipeSerializers {
    ...
    public static final WorkerRecipeSerializer<ConcentratorRecipe> CONCENTRATING = register("concentrating", new ConcentratorRecipe.ConcentratorRecipeSerializer(ConcentratorRecipe::new));
