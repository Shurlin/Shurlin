...
public class RecipeTypes {
    public static final RecipeType<WorkerRecipe> BREAKING = register("breaking");
    public static final RecipeType<WorkerRecipe> COLLECTING = register("collecting");
    public static final RecipeType<WorkerRecipe> CONCENTRATING = register("concentrating");
    public static final RecipeType<WorkerRecipe> EXTRACTING = register("extracting");
