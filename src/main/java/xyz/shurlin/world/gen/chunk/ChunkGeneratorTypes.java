...
public class ChunkGeneratorTypes {
    public static final Codec<HolyFarmerChunkGenerator> HOLY_PEAR_CHUNK_GENERATOR;
    ...
    static {
        HOLY_PEAR_CHUNK_GENERATOR = register("holy_pear", HolyFarmerChunkGenerator.CODEC);
    }
